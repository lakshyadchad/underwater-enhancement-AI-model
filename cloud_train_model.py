...
# Inside train_model.py (or define this in the notebook cell)
config = {
    "TRAIN_DIR_A": "/content/dataset_final/trainA", # Murky Input # Local fast storage
    "TRAIN_DIR_B": "/content/dataset_final/trainB", # Clear Target
    "BATCH_SIZE": 16,       # T4 GPU can handle 16 or 32 usually
    "LEARNING_RATE": 0.0002,  # Standard for GANs
    "EPOCHS": 100,            # How many times to show the whole dataset
    "DEVICE": "cuda", # CRITICAL: Save weights to Drive so they persist after crash
    "SAVE_DIR": "/content/drive/MyDrive/Underwater_Project/checkpoints/", # Where to save the trained brain
}
